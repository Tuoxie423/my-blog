<template>
  <div class="auth-popover">
    <el-popover v-if="isLoggedIn" width="280" trigger="click">
      <template #reference>
        <avatar :src="userStore.state.userInfo.avatar" :name="userStore.state.userInfo.username" :size="36"/>
      </template>
      <template #default>
        <div class="title">
        ...
        <div class="user-info">
          <avatar :src="userStore.state.userInfo.avatar" :name="userStore.state.userInfo.username" :size="50"/>
          ...
          <div class="container">
            ...
            <div class="oauth-login">
              <div class="login-item">
                <span class="qq-login" @click="qqLogin">QQ</span>
                QQ登录
              </div>
            </div>
          </div>
